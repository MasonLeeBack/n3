...
class NxFluid
	...
	*/
	...
	/**
	Not available in the current release.
	Returns the external force applied to each particle at each time step.
	*/
	virtual		NxVec3				getExternalForce()								const	= 0;

	/**
	Not available in the current release.
	Sets the external force applied to each particle at each time step.
	*/
	virtual		void 				setExternalForce(const NxVec3&)							= 0;
	...
	*/
	...
	/**
	Not available in the current release.
	Returns the fluid's factor for smoothing impulse transfer, used for collision with dynamic actors.
	*/
	virtual		NxReal				getDynamicActorReactionSmoothing()				const	= 0;

	/**
	Not available in the current release.
	Sets the fluid's factor for smoothing impulse transfer, used for collision with dynamic actors. 
	Has to between 0 and 1.
	*/
	virtual		void 				setDynamicActorReactionSmoothing(NxReal)				= 0;

	/**
	Not available in the current release.
	Returns the fluid's factor for scaling impulse transfer, used for collision with dynamic actors.
	*/
	virtual		NxReal				getDynamicActorReactionScaling()				const	= 0;

	/**
	Not available in the current release.
	Sets the fluid's factor for scaling impulse transfer, used for collision with dynamic actors. 
	*/
	virtual		void 				setDynamicActorReactionScaling(NxReal)				= 0;
