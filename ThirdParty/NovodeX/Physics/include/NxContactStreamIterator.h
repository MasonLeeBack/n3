...
class NxContactStreamIterator
	...
	*/
	...
	Fluid actor contact stream: If getShapeFlags()&NX_SF_HAS_FEATURES_PER_POINT is specified, this returns
	...
	*/
	...
	protected:
	const NxReal * pointNormalForce;	//only exists if (shapeFlags & NX_SF_POINT_CONTACT_FORCE)
