...
struct NxRaycastHit
	...
	NxVec3			worldNormal;									//!< Impact normal in world space (NX_RAYCAST_NORMAL / NX_RAYCAST_FACE_NORMAL)
	...
	NxMaterialIndex	materialIndex;									//!< Index of touched material (NX_RAYCAST_MATERIAL)
