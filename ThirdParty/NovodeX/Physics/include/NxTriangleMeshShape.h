...
class NxTriangleMeshShape: public NxShape
	...
	*/
	...
	/**
	Finds triangles touching world OBB.
	*/
	virtual	bool				overlapOBBTriangles(const NxBox worldOBB, NxU32 flags, NxU32& nb, const NxU32*& indices)	const	= 0;

	/**
	Finds triangles touching world Capsule.
	*/
	virtual	bool				overlapCapsuleTriangles(const NxCapsule worldCapsule, NxU32 flags, NxU32& nb, const NxU32*& indices)	const	= 0;

	/**
	Finds triangles touching world Sphere.
	*/
	virtual	bool				overlapSphereTriangles(const NxSphere worldSphere, NxU32 flags, NxU32& nb, const NxU32*& indices)	const	= 0;
	};
#endif
