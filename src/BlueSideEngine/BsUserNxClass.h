...
class CBsUserNxClass
{	
public:
	static NxUserOutputStream* GetUserOutputStream();
	static NxUserDebugRenderer& GetUserDebugRenderer();
	static NxUserTriggerReport* GetUserTriggerReport();	
};
