...
HRESULT PackedResource::Create( const CHAR* strFilename )
{
    ...
    HANDLE hFile = CBsFileIO::BsCreateFile( strFilename, GENERIC_READ, FILE_SHARE_READ, NULL,
    ...
    XPR_HEADER xprh;
    CBsFileIO::BsReadFile( hFile, &xprh, sizeof(XPR_HEADER), &dwNumBytesRead, NULL );
    ...
    CBsFileIO::BsReadFile( hFile, m_pSysMemData, m_dwSysMemDataSize, &dwNumBytesRead, NULL );
    CBsFileIO::BsReadFile( hFile, m_pVidMemData, m_dwVidMemDataSize, &dwNumBytesRead, NULL );
