...
vertexOutput mainVS(appdata IN) 
{
	...
	p.xyz += IN.Normal*(sin(IN.Position.x*10.f+fTime*4.2f)*0.05f + sin(IN.Position.x*20.f+fTime*8.4f)*0.03f );
	p.xyz += IN.Normal*(sin(IN.Position.y*6.f+fTime*7.2f)*0.05f  + sin(IN.Position.x*12.f+fTime*14.4f)*0.03f );
	p.xyz += IN.Normal*(sin(IN.Position.z*4.f+fTime*5.2f)*0.05f + sin(IN.Position.z*8.f+fTime*10.4f)*0.03f );
...
float4 mainPS(vertexOutput IN) : COLOR
{
	...
	float3 T = refract2(-V, N, etas[0], fail);
