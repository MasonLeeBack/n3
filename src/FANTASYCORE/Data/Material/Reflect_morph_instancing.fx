...
vertexOutput VS_TransformAndTexture_0(int i : INDEX) 
{
    ...
    float4 ObjPos1, ObjPos2;
    float4 Normal1, Normal2;
    float4 Texcoord;
	...
	asm {
			vfetch ObjPos1, Index, position0
			vfetch ObjPos2, Index, position1
			vfetch Normal1, Index, normal0
			vfetch Normal2, Index, normal1
	...
	// Matrix._44 에 Morph Weight 저장한다. 
	float3 ObjPos = lerp(ObjPos1, ObjPos2, InstanceMat4.w);
	float3 Normal =lerp(Normal1, Normal2, InstanceMat4.w);
    Normal = normalize(Normal);  

	InstanceMat._11_12_13_14 = InstanceMat1;
	InstanceMat._21_22_23_24 = InstanceMat2;
	InstanceMat._31_32_33_34 = InstanceMat3;
	InstanceMat._41_42_43_44 = float4(InstanceMat4.xyz, 1);	
