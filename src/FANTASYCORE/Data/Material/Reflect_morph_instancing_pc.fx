...
vertexOutput VS_TransformAndTexture_0(vertexInput0 IN) 
{
	...
	matWorld._41_42_43_44 = float4(IN.matWorld4.xyz, 1);
	
	// Matrix._44 에 Morph Weight 저장한다. 
	float3 ObjPos = lerp(IN.position0, IN.position1, IN.matWorld4.w);
	float3 Normal =lerp(IN.normal0, IN.normal1, IN.matWorld4.w);
